     ...
     function formValidationExample() {
	   ...
	   errMessages = validatePhoneNumber(errMessages);  // Call phone number validation function
     ...
     function validateSurname(errMessages) {
       ...
       var stringName = document.example.surname.value;
     ...
     function validatePhoneNumber(errMessages) {
       ...
       var str = document.example.phone.value;
       str = str.trim();
